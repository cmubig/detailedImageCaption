...
class ResNetC4Model(DetectionModel):
    ...
    def build_graph(self, *inputs):
        ...
        region_feature = tf.multiply(region_feature,region_mask,name='region_feature/output')
...
if __name__ == '__main__':
    ...
    output_tensor = ['sampled_captions']
    ...
    with progressbar.ProgressBar(max_value=len(files)) as bar:
	    for i,file in enumerate(files):
	    	...
	    	global_feature,region_feature = pred(resized_img,box[i])#(1,2048) (10,2048)
