...
from captioner.ros_caption_model import model as Model
...
class RosTensorFlow():
    def __init__(self):
        ...
        self.service = rospy.Service('scene_description',SceneDescription, self.handle_scene_description)
